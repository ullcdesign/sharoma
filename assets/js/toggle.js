...
document.getElementById('toSharoma').addEventListener('click' , function () {
  document.getElementById('line1').classList.remove('line1');
  document.getElementById('line2').classList.remove('line2');
  document.getElementById('line3').classList.remove('line3');
  document.getElementById('gNav').classList.remove('show');
...
document.getElementById('toShisha').addEventListener('click' , function () {
  document.getElementById('line1').classList.remove('line1');
  document.getElementById('line2').classList.remove('line2');
  document.getElementById('line3').classList.remove('line3');
  document.getElementById('gNav').classList.remove('show');
...
document.getElementById('toAccess').addEventListener('click' , function () {
  document.getElementById('line1').classList.remove('line1');
  document.getElementById('line2').classList.remove('line2');
  document.getElementById('line3').classList.remove('line3');
  document.getElementById('gNav').classList.remove('show');
...
document.getElementById('toReserve').addEventListener('click' , function () {
  document.getElementById('line1').classList.remove('line1');
  document.getElementById('line2').classList.remove('line2');
  document.getElementById('line3').classList.remove('line3');
  document.getElementById('gNav').classList.remove('show');
